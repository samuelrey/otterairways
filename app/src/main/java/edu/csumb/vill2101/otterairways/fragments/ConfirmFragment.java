...
public class ConfirmFragment extends Fragment {
    ...
    public interface ConfirmFlight {
        void confirm();
    }
    ...
    public void onAttach(Context context) {
        ...
        try {
            this.confirmFlight = (ConfirmFlight) context;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        details.setText(getArguments().getParcelable("flight").toString() + getArguments().getParcelable("account").toString());
